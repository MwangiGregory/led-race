...
#define BOARD_TYPE      3           //Choose between 0=UNO, 1=NANO or 2=EVERY board

#define TRACK_LENGTH    29      //Default length of track used for race
...
#define P1 14    // switch player 1 to PIN and GND
#define PL1 4  // switch player 1 light
#define P2 32    // switch player 2 to PIN and GND
#define PL2 21   // switch player 2 light
#define P3 15    // switch player 3 to PIN and GND
#define PL3 27   // switch player 3 light
#define P4 26    // switch player 4 to PIN and GND
#define PL4 25   // switch player 4 light
...
#elif BOARD_TYPE == 3
#define MAXLED          29     //MAX LEDs supported (=<300 for standard arduino with 2kB of memory)(Must be equal to or more than TRACK_LENGTH)
#define TIMES_TO_SAVE   10      //Number of different lap records to save. Note that increasing this will increase memory usage.
#define NR_OF_LAPS      5       //Default number of laps
#define OFFSET          41      //Clockspeed dependent compensation for better time accuracy
#define SERIAL          Serial //Serial1 is RX/TX on Nano EVERY board
#define DEF_DUAL_STRIP  true
#else
#define MAXLED          300
...
void setup() {
    ...
    #elif BOARD_TYPE==3
    Serial.begin(115200);
    Serial.println(F("Running esp32 mini board configuration"));
    #else
